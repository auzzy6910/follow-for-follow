    ...
    >
      <div className="flex items-center justify-between px-4 py-3 border-b border-dark-600">
        <div className="flex items-center gap-2">
          ...
          {unreadCount > 0 && (
            <span className="text-[10px] font-semibold text-white bg-blue-accent px-1.5 py-0.5 rounded-full">
              {unreadCount}
            </span>
          )}
        </div>
      ...
      {inboxNotifications.length > 0 && (
        <div className="flex items-center justify-between px-4 py-2 border-t border-dark-600 bg-dark-900/50">
          <button
            ...
            className="flex items-center gap-1 text-xs text-gray-700 hover:text-blue-accent disabled:opacity-40 disabled:hover:text-gray-700"
          >
