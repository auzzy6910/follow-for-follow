      ...
      <div className="px-3 sm:px-4 pb-3 sm:pb-4 -mt-6 sm:-mt-10 relative">
        <div className="flex items-end gap-2 sm:gap-3 mb-2 sm:mb-3 min-w-0">
          <img
            src={user.avatar}
            alt=""
            className={`w-11 h-11 sm:w-16 sm:h-16 rounded-full border-2 object-cover shrink-0 ${user.tier === 'legend' ? 'border-amber-400' : user.tier === 'influencer' ? 'border-green-accent' : 'border-dark-500'}`}
          />
