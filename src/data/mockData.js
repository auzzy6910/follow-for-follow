...
export const WARNINGS = [
  {
    ...
    type: 'unfollow',
    severity: 'warning',
    title: 'Unfollow detected within escrow period',
    description: 'You unfollowed @CryptoKingNairobi within 30 days. 150 credits have been slashed from your account.',
    creditsSlashed: 150,
    createdAt: '2026-04-25T10:30:00Z',
    status: 'active',
    appealDeadline: '2026-05-02T10:30:00Z',
  },
  {
    id: 'w2',
    type: 'rate_limit',
    severity: 'info',
    title: 'Approaching daily follow limit',
    description: 'You have used 42 of your 50 daily follows. Slow down to avoid a temporary cooldown.',
    creditsSlashed: 0,
  ...
  },
  {
    ...
    description: 'Rapid follow/unfollow pattern detected on your account. Repeated offenses may result in a 7-day suspension.',
    creditsSlashed: 0,
    createdAt: '2026-04-20T08:00:00Z',
    status: 'appealed',
    appealDeadline: '2026-04-27T08:00:00Z',
  },
  {
    id: 'w4',
    type: 'low_trust',
    severity: 'warning',
    title: 'Moved to Low Trust pool',
    description: 'Your unfollow rate exceeded 10%. You have been moved to the Low Trust pool with reduced visibility until your rate improves.',
    creditsSlashed: 0,
...
export const GLOBAL_NOTIFICATIONS = [
  {
    ...
    message: '@FitnessMaverick followed you back',
  ...
  },
  {
    ...
    message: '300 credits released from @DesignDailyHQ escrow',
  ...
  },
  {
    id: 'gn3',
    type: 'penalty',
    title: 'Credits slashed',
    message: '150 credits slashed — unfollowed @CryptoKingNairobi within 30 days',
  ...
  },
  {
    ...
    message: 'You completed "Follow 5 users in Tech tribe" — +50 credits',
    avatar: null,
  ...
  },
  {
    ...
    type: 'follow_back',
    title: 'New follow-back!',
    message: '@GameStreamPro followed you back',
  ...
  },
  {
    ...
    type: 'escrow',
    title: 'Escrow held',
    message: '500 credits locked in escrow for @CryptoKingNairobi',
    avatar: USERS[0].avatar,
  ...
  },
  {
    ...
    message: 'You reached a 7-day streak — +200 credits bonus',
    avatar: null,
