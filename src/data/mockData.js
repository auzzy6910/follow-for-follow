...
const USER_USERNAMES = [
  ...
  'NomadCoder_', 'PixelPainter', 'SoundWaveLab', 'StartupSensei',
  'MindfulMoves', 'LensLover_', 'HypeBeastDaily', 'GrindMindset',
  'DefiDreamer', 'ArenaLegend', 'SpiceRouteChef', 'TransformCoach',
  'NFTNinja', 'DailyDispatch', 'AngelInvestor_', 'GlamourGuru',
  'BlockchainBuilder', 'SquadGamerHQ', 'PastryPioneer', 'IronCoach',
  'CanvasDreams', 'CityVlogger', 'VentureVibes', 'CoutureConnoisseur'
]
...
const USER_DISPLAY_NAMES = [
  ...
  'Nomad Coder', 'Pixel Painter', 'Soundwave Lab', 'Startup Sensei',
  'Mindful Moves', 'Lens Lover', 'Hype Beast', 'Grind Mindset',
  'Defi Dreamer', 'Arena Legend', 'Spice Route', 'Transform Coach',
  'NFT Ninja', 'Daily Dispatch', 'Angel Invest', 'Glamour Guru',
  'Block Builder', 'Squad Gamer', 'Pastry Pioneer', 'Iron Coach',
  'Canvas Dreams', 'City Vlogger', 'Venture Vibes', 'Couture Conn'
]
...
const USER_BIOS = [
  ...
  'Remote dev & travel hacker. Code anywhere.',
  'Painting pixels & dreams. Gallery shows monthly.',
  'Producing beats for the next generation of artists.',
  'Helping founders ship faster. Newsletter weekly.',
  'Movement, mobility & mindset. Train smart, live well.',
  'Capturing golden hour & city skylines worldwide.',
  'Drops, fits & culture. Daily streetwear updates.',
  'Discipline > motivation. Daily mindset reminders.',
  'DeFi farmer. Sharing on-chain alpha for free.',
  'Top 1% Apex Legends. Tournament finalist.',
  'Authentic flavors from the silk road. Recipes inside.',
  'Body recomp coach. Macros, lifts & long-term wins.',
  'Generative artist. NFT drops every month.',
  'Daily news roundup for busy creators.',
  'Backing pre-seed founders. Sharing the playbook.',
  'Editorial fashion & beauty. Brand partnerships open.',
  'Smart-contract auditor. Web3 security threads.',
  'Squad-based shooters & community game nights.',
  'Pastry chef turning desserts into edible art.',
  'Powerlifting coach. PRs are a state of mind.',
  'Mixed media artist. Big canvas, bigger ideas.',
  'POV walking tours of the world\'s best cities.',
  'Operator turned investor. Helping ops-led founders.',
  'High fashion meets street. Luxury edits weekly.'
]

export const USERS = Array.from({ length: 48 }, (_, i) => ({
  id: `user-${i + 1}`,
  username: USER_USERNAMES[i],
  displayName: USER_DISPLAY_NAMES[i],
